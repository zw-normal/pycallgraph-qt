...
var root = tree(data);
var svg = d3.select("#call-graph-plot").append("svg:svg");
...
var textGroup = svg.append("g").attr("font-family", "sans-serif").attr("font-size", 10).attr("stroke-linejoin", "round").attr("stroke-width", 3).selectAll("text").data(root.descendants()).join("text").attr("transform", function (d) {
...
var _svg$node$getBBox = svg.node().getBBox(),
    x = _svg$node$getBBox.x,
    y = _svg$node$getBBox.y,
    width = _svg$node$getBBox.width,
    height = _svg$node$getBBox.height;

svg.attr("viewBox", [x, y, width, height]);
},{"d3":"node_modules/d3/index.js","qwebchannel":"node_modules/qwebchannel/qwebchannel.js"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/resource.e31bb0bc.js.map